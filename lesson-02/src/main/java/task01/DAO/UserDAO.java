...
public class UserDAO {
	...
	private static String CREATE = "insert into user(`first_name`,`last_name`,`email`) values (?,?,?)";
	private static String READ_BY_ID = "select * from user where id=?";
	private static String UPDATE_BY_ID = "update user set first_name=?, last_name=?, email=? where id=?";
