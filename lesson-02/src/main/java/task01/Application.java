...
public class Application {
	...
	public static void main(String[] args)
		...
		userList.add(new User("John", "Miller", "john_miller@gmail.com"));
		userList.add(new User("Peter", "Smith", "peter_smith@gmail.com"));
		userList.add(new User("David", "Brown", "david_brown@gmail.com"));
		userList.add(new User("Joseph", "Rodriguez", "joseph_rodriguez@gmail.com"));
		userList.add(new User("Christopher", "Hernandez", "cristopher_hernandez@gmail.com"));
